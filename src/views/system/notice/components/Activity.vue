  ...
  <div class="user-activity">
    <el-row> 
      ...
      <el-col :span="15">
        ...
        <!-- <el-button 
          class="filter-item" 
          style="width:190px; margin-left: 50px; margin-top:15px ; margin-bottom:25px ; "
          type="primary" 
          icon="el-icon-plus"
    ...
    <div v-for="(noticeItem,index) in noticeList">
      <div class="post">
        ...
        <el-collapse>
          ...
          <template slot="title" >
            <el-badge v-if="noticeItem.noticeIsseen==0" style="margin-right:10px" is-dot></el-badge> 
...
export default {
  ...
  created() {  
    ...
    console.log(param)
    fetchNoticeList(param).then(response => {  
