...
export const constantRoutes = [
  //========================================= 
  {
    path: '/saveScoreWithList',
    component: () => import('@/views/system/score/Home/adminHome/saveScoreWithList/'),
    hidden: true
  },
  {
    path: '/saveScoreWithXls',
    component: () => import('@/views/system/score/Home/adminHome/saveScoreWithXls/'),
    hidden: true
  },
  {
    path: '/Myprofile',
    ...
    children: [
      {
        ...
        name: 'Dashboard',
        meta: { title: '智能教学质量管理平台', icon: 'dashboard', affix: true }
      }
    ]
  },
  // {
